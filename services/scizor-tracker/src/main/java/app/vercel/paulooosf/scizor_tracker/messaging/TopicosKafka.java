package app.vercel.paulooosf.scizor_tracker.messaging;

public final class TopicosKafka {

    public static final String BUG_CRIADO = "bug.criado";
    public static final String BUG_STATUS_ALTERADO = "bug.status.alterado";
